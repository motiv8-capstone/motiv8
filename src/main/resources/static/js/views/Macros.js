            ...
            <div class="col-sm-6 text-black">
                ...
                <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                    ...
                    <form style="width: 23rem;">
                        ...
                        <div class="form-outline mb-4">
                            <input type="height" id="height" class="form-control form-control-lg" />
                            <label class="form-label" for="height">Height</label>
                        </div>

                        <div class="form-outline mb-4">
                            <input type="weight" id="weight" class="form-control form-control-lg" />
    ...
    <select id="activity-level" name="activity-level">
 	...
 	<select id="goals" name="goals">
 		...
 		<option value="extremegain">Extreme Weight Gain</option>
                        ...
                        <div class="pt-1 mb-4">
                            <button id="login-btn" class="btn btn-info btn-lg btn-block" type="button">Calculate Calories!</button>
                        </div>
